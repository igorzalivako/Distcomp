...
public class ReactionController {
    ...
    public ResponseEntity<List<ReactionResponseTo>> getReactionsByTweetId(@PathVariable Long tweetId) {
        List<ReactionResponseTo> response = reactionService.getReactionsByTweetId(tweetId);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
}
